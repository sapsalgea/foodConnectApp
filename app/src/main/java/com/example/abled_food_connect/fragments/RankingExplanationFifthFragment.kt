 ...
 * Use the [RankingExplanationFifthFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RankingExplanationFifthFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RankingExplanationFifthFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RankingExplanationFifthFragment().apply {
