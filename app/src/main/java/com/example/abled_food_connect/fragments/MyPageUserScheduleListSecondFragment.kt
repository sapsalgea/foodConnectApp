...
class MyPageUserScheduleListSecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(
            R.layout.fragment_my_page_user_schedule_list_second,
            container,
            false
        )
        ...
        ScheduleListRv = view.findViewById<RecyclerView>(R.id.scheduleSecondListRv)
            ...
            override fun onResponse(
                ...
                if (items != null) {
                    ...
                    for(i in 0..dbGetArraylist.size-1){
                        if(dbGetArraylist.get(i).meeting_result == 1){
