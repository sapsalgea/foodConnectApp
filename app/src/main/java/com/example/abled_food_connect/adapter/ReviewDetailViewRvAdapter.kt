...
class ReviewDetailViewRvAdapter () : RecyclerView.Adapter<ReviewDetailViewRvAdapter.CustromViewHolder>(){

    var ReviewDetailList = ArrayList<ReviewFragmentLodingDataItem>()
